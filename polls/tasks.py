...
"""
Celery will automatically search for tasks within each of your registered Django app's
because we called the autodiscover_tasks method in core/celery.py.
https://docs.celeryq.dev/en/stable/reference/celery.html#celery.Celery.autodiscover_tasks
"""
...
"""
Task Base Class#
If you find yourself writing the same retry arguments in your Celery task decorators, 
you can (as of Celery 4.4) define retry arguments in a base class, 
which you can then use as a base class in your Celery tasks:
